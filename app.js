(() => {
  ...
  const packages = {
    ...
    system: {
      ...
      bullets: [
        "Five to ten custom pages",
        "Events and conversion support",
        "Custom interaction or integrations",
      ],
    },
    product: {
      name: "Product Site",
      ...
      bullets: [
        "Product or catalog experience",
        "Checkout or platform integration",
